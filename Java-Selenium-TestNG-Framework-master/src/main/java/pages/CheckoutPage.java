 ...
 * 
 * By firstNameField = By.name("firstName"); By lastNameField =
 ...
 * xpath("//div[@class=' _64f3'][contains(text(), 'Please specify a valid email')]"
 * );
 * 
 * WebDriver driver; WebDriverWait wait;
 * 
 * public CheckoutPage(WebDriver driver) { this.driver=driver; wait = new
 ...
 * 
 * public void enterCity(String city) { driver.findElement(cityField).clear();
 * driver.findElement(cityField).sendKeys(city); }
 * 
 * public void selectState(String state) { new
 * Select(driver.findElement(stateProvinceDropdown)).selectByValue(state); }
 * 
 ...
 * 
 * public boolean isErrorContainerDisplayed() { return
 * wait.until(ExpectedConditions.visibilityOfElementLocated(errorContainer)).
 * isDisplayed(); }
 * 
 * public boolean isContinueButtonEnabled() { return
