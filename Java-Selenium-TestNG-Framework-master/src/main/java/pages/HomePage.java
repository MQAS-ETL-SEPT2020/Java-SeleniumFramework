...
public class HomePage {
	...
	public void menu(Object menuname) {
		if (menuname == DigitalDownloads) {
	 ...
	 * }
	 * 
	 * public boolean getLogo() { return
	 * driver.findElement(oculusLogo).isDisplayed(); }
	 * 
	 * public void clickLogInLink() { driver.findElement(signinLink).click(); }
	 * 
	 * public void clickSigninLink() {
	 * wait.until(ExpectedConditions.elementToBeClickable(signinButton));
	 * driver.findElement(signinButton).click(); }
	 * 
	 * public void hoverOverCommunityTab() { new
	 * Actions(driver).moveToElement(driver.findElement(communityTab)).perform(); }
	 * 
	 * public void clickOnForumsTab() { driver.findElement(forumsTab).click(); }
	 * 
	 * public void switchTabs() { ArrayList<String> tabs = new
	 * ArrayList<String>(driver.getWindowHandles());
	 * driver.switchTo().window(tabs.get(1)); }
	 * 
	 * public void hoverOverHeadsetsTab() { new
	 * Actions(driver).moveToElement(driver.findElement(headsetsTab)).perform();
	 * 
	 * }
	 * 
	 * public List<WebElement> headsetsDropdownResults(){ return
	 * driver.findElement(headsetsDropdown).findElements(headsetsDropdownResults); }
	 * 
	 * public void clickOculusQuest() { driver.findElement(oculusQuest).click(); }
	 * 
	 ...
	 * 
	 * public boolean isCartPageLoaded() { return
