...
//		Reporter.log("DIGITAL DOWNLOADS page is  displayed", true);
		Assert.assertTrue(digitaldownloads.digitalDownloadsPageText(), "Not dispalying DIGITAL DOWNLOADS page");
		...
		Assert.assertTrue(digitaldownloads.defaultDisplayPerPage(), "Not displaying 8 option");
		...
		Assert.assertTrue(thirdalbum.thirdAlbumPageText(), "Not displaying 3rd image page");

		Reporter.log("Price is displayed", true);
		Assert.assertTrue(thirdalbum.defaultPrice(), "Not displaying Price");

		Reporter.log("Quantity is displayed", true);
		Assert.assertTrue(thirdalbum.defaultQuantity(), "Not Quantity is displayed1");
		...
		Assert.assertTrue(thirdalbum.displayconfirmationMessagePopup(),
		...
		Assert.assertTrue(shoppingcart.shoppingCart(), "Not displaying Shopping cart page");

		shoppingcart.clickOnTermsAndConditions();
		Reporter.log("Clicking on TermsAndConditions checkbox", true);
		Assert.assertTrue(shoppingcart.termsAndCondition(), "Not clicking on TermsAndConditions checkbox");
		...
		Assert.assertTrue(checkout.checkOutPageText(), "Not displaying Check out page");
		
		Reporter.log("Selecting New Address", true);
		Assert.assertTrue(checkout.selectingNewAdress(), "Not displaying Eight option");
		
		checkout.cityName("Bengaluru");
		Reporter.log("Entering cityname in City textfield page", true);
